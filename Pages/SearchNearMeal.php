...
<h2 class="page-title">Search Nearest Meal</h2>
...
<fieldset>
<legend><b>Nearest Meal</b></legend>
...
$result2= $conn->query("select * From meal_shops where latitude>=$lat1 and latitude<=$lat2 and longitude>=$log1 and longitude<=$log2 ");
