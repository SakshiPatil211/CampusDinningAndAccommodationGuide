...
$result = $conn->query("select * From meal_shops where MID=$MID");
		...
		<fieldset>
			...
			<form action="#" method="post">
				...
				<div style="float:left;padding:10px;margin-right:20px;"><img src="upload/<?php echo $row['Pic']; ?>" style="border-radius: 60px;border: 2px solid #777777;width:100px;height:100px;" ></div>'
						...
						<br>
					<B>Name</B> : <?php echo $row['Sname'];?><br>
...
<?php
$result1 = $conn->query("select ROUND(avg(Rateval)) as tRate From ratingmeal where Mid=$MID");
...
<?php
$result1 = $conn->query("select * From commentmeal,userdb where commentmeal.Uid=userdb.Uid and commentmeal.Mid=$MID");
...
<script type="text/javascript" src="js/jquery.form.js"></script>
			...
			<form id="create_account" action="commentMeal.php" method="post" name="contact" enctype="multipart/form-data">
	

			<input class="form-control" type="hidden" name="Uid" value="<?php echo $id;?>" id="mbuid1">
			<input class="form-control" type="hidden" name="Rid" value="<?php echo $MID;?>" id="Rid1">
			...
			<form id="create_accountRating" action="RatingMeal.php" method="post" name="contact" enctype="multipart/form-data">
