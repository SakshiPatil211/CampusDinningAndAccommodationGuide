...
$result = $conn->query("select * From hostel where UID=$id");
...
<script type="text/javascript" src="js/jquery.form.js"></script>
			...
			<form id="create_account" action="Hosteluserup.php" method="post" name="contact" enctype="multipart/form-data">
				<input type="hidden" Name="HID" value="<?php echo $row['HID'];?>" />

				<dl>
					<dt>Hostel Name:</dt>
					<dd><input type="text" size="30" name="Hname" class="input-text" value="<?php echo $row['Hname'];?>" /></dd>
					<dt>Mobile No:</dt>
...
<script type="text/javascript" src="js/jquery.form.js"></script>
			...
			<form id="create_account" action="Hosteluserup.php" method="post" name="contact" enctype="multipart/form-data">
				...
				<dl>
					<dt>Hostel Name:</dt>
					<dd><input type="text" size="30" name="Hname" class="input-text" value="" /></dd>
					<dt>Mobile No:</dt>
